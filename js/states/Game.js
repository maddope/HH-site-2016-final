...
MrHop.GameState = {
  ...
  create: function() {
    ...
    //create the player
    this.player = this.add.sprite(100, 280, 'player');
    this.player.anchor.setTo(0.5);
    this.player.animations.add('running', [0, 1, 2, 3, 2, 1], 15, true);
    this.game.physics.arcade.enable(this.player);
    
    //change player bounding box
    this.player.body.setSize(56, 120, 0, 0);
    this.player.play('running');
    
    //hard-code first platform
    this.currentPlatform = new MrHop.Platform(this.game, this.floorPool, 11, 91, 400, -this.levelSpeed, this.coinsPool);
    ...
    var style = {font: '60px lubalinbold-webfont', fill: '#fff'};
  ...
  gameOver: function(){
    ...
    gameOverPanel.onComplete.add(function(){
      ...
      var style = {font: '30px lubalinbold-webfont', fill: '#fff'};
      this.add.text(this.game.width/2, this.game.height/2.75, 'YOU BAGGED A LOT OF TOYS.', style).anchor.setTo(0.5);
      
	  var style = {font: '40px lubalinbold-webfont', fill: '#fff'};
      this.add.text(this.game.width/2, this.game.height/2, 'TRY AGAIN!', style).anchor.setTo(0.5);
	  
      style = {font: '20px gotham_rounded', fill: '#fff'};
